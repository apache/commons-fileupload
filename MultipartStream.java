...
public class MultipartStream {
     ...
     */
    public static int HEADER_PART_SIZE_MAX = 10240;
    ...
    public MultipartStream(InputStream input,
        ...
        if (System.getProperty("HEADER_PART_SIZE_MAX") != null) {
          HEADER_PART_SIZE_MAX = Integer.parseInt(System.getProperty("HEADER_PART_SIZE_MAX"));
        }
        head = 0;
        tail = 0;
    }
