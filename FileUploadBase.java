        ...
        private boolean findNextItem() throws IOException {
            ...
            for (;;) {
                ...
                if (currentFieldName == null) {
                    ...
                    fieldName = fieldName == null ? "" : fieldName; // KWA Modified : Support no content-disposition bodies
                    if (fieldName != null) {
                    ...
                    String fileName = getFileName(headers);
                    fileName = fileName == null ? "" : fileName; // KWA Modified : Support no content-disposition bodies
                    if (fileName != null) {
                        currentItem = new FileItemStreamImpl(fileName,
                                currentFieldName,
